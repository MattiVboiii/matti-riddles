...
Config.PriceMethod = "cash" -- "bank" or "cash"
...
Config.Riddles = {
	[1] = {
		...
		optionalClothing = "S606M2PT", -- Works only if model is mp_m_freemode_01 (or mp_f_freemode_01), can be empty, need to be a citizenid, will get current outfit of the player with that citizenid
